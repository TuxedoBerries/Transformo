...
public class FieldTypeTranslations {
    ...
    private static final HashMap<String, FieldType> _cSharpTranslation = new HashMap<String, FieldType>();
    private static final HashMap<FieldType, String> _cSharpTranslationBack = new HashMap<FieldType, String>();
